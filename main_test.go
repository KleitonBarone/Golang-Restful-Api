...
func TestPatchAlbumByIDRejectsInvalidRequests(t *testing.T) {
	tests := []struct {
		...
		{name: "null title", path: "/albums/2", body: `{"title":null}`, wantStatus: http.StatusBadRequest, wantMessage: "invalid request body"},
		{name: "null artist", path: "/albums/2", body: `{"artist":null}`, wantStatus: http.StatusBadRequest, wantMessage: "invalid request body"},
